...
abstract class ApiResponse {
  ...
  /**
   * Prepares the API response to be sent.
   * @param res - The Express response object.
   * @param response - The API response object.
   * @param headers - Additional headers to be included in the response.
   * @returns The prepared Express response object.
   */
  ...
  /**
   * Sanitizes the API response by removing undefined properties and the 'status' property.
   * @param response - The API response object.
   * @returns The sanitized API response object.
   */
